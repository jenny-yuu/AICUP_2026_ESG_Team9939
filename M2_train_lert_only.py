# ============================================================
# VeriPromise ESG M2 - MultiTask Single Model: lert × 3 Seed × 5-fold
# ============================================================
# 整合..的 electra 程式碼架構：
#
...
SEVEN_MODELS = {
    "lert": ("hfl/chinese-lert-base", 16),  # single model version
}
...
print(f"\n{'#'*120}")
print("M2 單模型開始：lert MultiTaskModel × 3Seed × 5fold")
...
print("="*80)
print("✅ 單模型 lert 訓練完成。")
print("📌 這份程式只負責產生 /content/M2_pkl/M2_lert.pkl")
...
║  ✅ 4任務 loss 加總，互相正則化                                          ║
║  ✅ MAX_LEN=384（更長上下文）                                            ║
║  ✅ 單模型 lert × 3 seeds × 5 folds → 1 pkl                           ║
