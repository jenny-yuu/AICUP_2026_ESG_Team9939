# ============================================================
# VeriPromise ESG M2 - MultiTask Single Model: ernie × 3 Seed × 5-fold
# ============================================================
# 整合..的 electra 程式碼架構：
#
...
SEVEN_MODELS = {
    "ernie": ("nghuyong/ernie-3.0-base-zh", 16),  # single model version
}
...
print(f"\n{'#'*120}")
print("M2 單模型開始：ernie MultiTaskModel × 3Seed × 5fold")
...
print()
print("="*80)
print("✅ 單模型 ernie 訓練完成。")
print("📌 這份程式只負責產生 /content/M2_pkl/M2_ernie.pkl")
...
║  ✅ 4任務 loss 加總，互相正則化                                          ║
║  ✅ MAX_LEN=384（更長上下文）                                            ║
║  ✅ 單模型 ernie × 3 seeds × 5 folds → 1 pkl                           ║
