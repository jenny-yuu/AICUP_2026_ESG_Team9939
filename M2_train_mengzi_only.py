# ============================================================
# VeriPromise ESG M2 - MultiTask Single Model: mengzi × 3 Seed × 5-fold
# ============================================================
# 整合學姊的 electra 程式碼架構：
#
...
SEVEN_MODELS = {
    "mengzi": ("Langboat/mengzi-bert-base", 16),  # single model version
}
...
print(f"\n{'#'*120}")
print("M2 單模型開始：mengzi MultiTaskModel × 3Seed × 5fold")
...
print()
print("="*80)
print("✅ 單模型 mengzi 訓練完成。")
print("📌 這份程式只負責產生 /content/M2_pkl/M2_mengzi.pkl")
...
║  ✅ 4任務 loss 加總，互相正則化                                          ║
║  ✅ MAX_LEN=384（更長上下文）                                            ║
║  ✅ 單模型 mengzi × 3 seeds × 5 folds → 1 pkl                           ║
